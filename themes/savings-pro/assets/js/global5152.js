...
jQuery( document ).ready(function( $ ) {
    ...
    function listingCouponItem( context ) {
        ...
        $( '.coupon-save', context ).each( function () {
            ...
            var icon ='heart', empty_icon = 'outline empty', loading_icon = 'spinner loading';
    ...
    $('#nav_toggle_open').click(function () {
        ...
        $('#nav_toggle_close').removeClass("nav_toggle_inactive");
    ...
    $('#nav_toggle_close').click(function () {
        ...
        $('#nav_toggle_open').removeClass("nav_toggle_inactive");
        ...
        $(document).scroll(function () {
            ...
            if ( w > mobileBreakPoint ) {
                ...
                if (top > navTop - adminbarH) {
                    ...
                    headerNav.css({position: 'fixed', top: ( is_fixed_admin_bar ) ? adminbarH : 0, left: 0, right: 0, width: '100%', zIndex: 1});
                } else {
...
//ref-modal
        jQuery("#wpu-reg-btn").click(function () {
            jQuery(".wpu-modal").addClass("is-visible");
            jQuery(".wpu-register-form").addClass("is-selected");
            jQuery(".wpu-login-form").removeClass("is-selected");
            jQuery(".wpu-form-reset-password").removeClass("is-selected");
        });